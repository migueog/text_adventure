...
export const SURFACE_LOCATIONS: Record<number, Location> = {
  ...
  12: { name: 'Supply Cache', description: 'Abandoned supplies from a previous expedition. Gain D3 SP when first explored.', effect: 'gainSP', value: 'D3', searchRule: { type: 'sp', amount: 'd3+1' } },
  13: { name: 'Observation Post', description: 'High ground with excellent visibility. Scout action costs 1 less SP from here.', effect: 'cheapScout', searchRule: { type: 'cp', amount: 1 } },
  14: { name: 'Crashed Vessel', description: 'Wreckage that may contain useful salvage. Search to gain D3 SP.', effect: 'searchSP', searchRule: { type: 'sp', amount: 'd3' } },
  15: { name: 'Frozen Outpost', description: 'An ice-covered structure. Nothing of note.', effect: 'none', searchRule: { type: 'sp', amount: 1 } },
  16: { name: 'Sensor Array', description: 'Functional detection equipment. Gain 1 CP when explored.', effect: 'gainCP', value: 1, searchRule: { type: 'cp', amount: 1 } },
  21: { name: 'Barren Wastes', description: 'Nothing but ice and rock.', effect: 'none', searchRule: null },
...
export const TOMB_LOCATIONS: Record<number, Location> = {
  ...
  34: { name: 'Ancient Archive', description: 'Records of eons past. Gain 1 CP when explored.', effect: 'gainCP', value: 1, searchRule: { type: 'cp', amount: 2 } },
  35: { name: 'Void Shield Generator', description: 'Defensive systems still active. Gain 2 CP when explored.', effect: 'gainCP', value: 2, searchRule: { type: 'cp', amount: 1 } },
  36: { name: 'Transdimensional Portal', description: 'A gateway to another part of the tomb. Can teleport to any other Portal hex.', effect: 'portal', searchRule: null }
}
